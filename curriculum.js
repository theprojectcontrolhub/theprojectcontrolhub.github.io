...
const TRACK6 = {
    ...
    totalWeeks: 26,
    weeks: [
        { phase: "Phase A \u2014 What feeds you", n: 1, title: "What project controls produces, and what it must be fed", short: "What it produces, what it needs", status: "live", page: "reporting-week-1.html", date: "Sep 20, 2028" },
        { n: 2, title: "Working backwards from a deliverable \u2014 output, inputs, owners, units", short: "Working backwards", status: "live", page: "reporting-week-2.html", date: "Sep 27, 2028" },
        { n: 3, title: "Engineering feeds you \u2014 deliverables, IFC, and approved with comments", short: "Engineering feeds you", status: "live", page: "reporting-week-3.html", date: "Oct 4, 2028" },
        { n: 4, title: "Engineering progress \u2014 where percent complete is easiest to fake", short: "Engineering progress", status: "live", page: "reporting-week-4.html", date: "Oct 11, 2028" },
        { n: 5, title: "Procurement feeds you \u2014 PO status, expediting, shipping, vendor data", short: "Procurement feeds you", status: "live", page: "reporting-week-5.html", date: "Oct 18, 2028" },
        { n: 6, title: "Material at site \u2014 delivered, stored, issued, installed", short: "Material at site", status: "live", page: "reporting-week-6.html", date: "Oct 25, 2028" },
        { n: 7, title: "Construction: quantities \u2014 three numbers for the same wall", short: "Construction: quantities", status: "live", page: "reporting-week-7.html", date: "Nov 1, 2028" },
        { n: 8, title: "Construction: progress \u2014 who measures, in what unit, on which day", short: "Construction: progress", status: "live", page: "reporting-week-8.html", date: "Nov 8, 2028" },
        { n: 9, title: "Ready means six different things \u2014 drawing, material, access, permit, labour, plant", short: "Ready means six different things", status: "live", page: "reporting-week-9.html", date: "Nov 15, 2028" },
        { n: 10, title: "Construction: hours and plant \u2014 allocation, availability, utilisation, idle time", short: "Hours and plant", status: "live", page: "reporting-week-10.html", date: "Nov 22, 2028" },
        { n: 11, title: "QA/QC feeds you \u2014 NCRs, inspection requests, and progress that reverses", short: "QA/QC feeds you", status: "live", page: "reporting-week-11.html", date: "Nov 29, 2028" },
        { n: 12, title: "HSE feeds you \u2014 permits, holds, stand-downs and lost time as delay events", short: "HSE feeds you", status: "live", page: "reporting-week-12.html", date: "Dec 6, 2028" },
        { n: 13, title: "Document control feeds you \u2014 revision status, and why half the site builds to Rev B", short: "Document control feeds you", status: "live", page: "reporting-week-13.html", date: "Dec 13, 2028" },
        { n: 14, title: "Commercial feeds you \u2014 commitments, accruals and invoices on somebody else\u2019s cut-off", short: "Commercial feeds you", status: "live", page: "reporting-week-14.html", date: "Dec 20, 2028" },
        { n: 15, title: "The client feeds you \u2014 instructions, approvals, comments: time rather than data", short: "The client feeds you", status: "live", page: "reporting-week-15.html", date: "Dec 27, 2028" },

        { phase: "Phase B \u2014 What you issue", n: 16, title: "The calendar \u2014 data date, cut-off, and three departments closing on three days", short: "The calendar", status: "live", page: "reporting-week-16.html", date: "Jan 3, 2029" },
        { n: 17, title: "The daily report \u2014 the shortest document with the most consequences", short: "The daily report", status: "live", page: "reporting-week-17.html", date: "Jan 10, 2029" },
        { n: 18, title: "The weekly report and the look-ahead \u2014 and the only part anyone acts on", short: "Weekly report and look-ahead", status: "live", page: "reporting-week-18.html", date: "Jan 17, 2029" },
        { n: 19, title: "The monthly report \u2014 curve, variance, narrative, and the summary read first", short: "The monthly report", status: "live", page: "reporting-week-19.html", date: "Jan 24, 2029" },
        { n: 20, title: "Four audiences, four altitudes \u2014 one number told four ways, not four stories", short: "Four audiences, four altitudes", status: "live", page: "reporting-week-20.html", date: "Jan 31, 2029" },
        { n: 21, title: "Dashboards \u2014 who reads what, and what a dashboard cannot say", short: "Dashboards", status: "live", page: "reporting-week-21.html", date: "Feb 7, 2029" },
        { n: 22, title: "KPIs, leading and lagging \u2014 last month against next month", short: "KPIs, leading and lagging", status: "live", page: "reporting-week-22.html", date: "Feb 14, 2029" },
        { n: 23, title: "Minutes, actions and closure \u2014 and the recovery action list under pressure", short: "Minutes, actions and closure", status: "live", page: "reporting-week-23.html", date: "Feb 21, 2029" },
        { n: 24, title: "The register system \u2014 assumption, risk, change; interface, constraint, delay", short: "The register system", status: "live", page: "reporting-week-24.html", date: "Feb 28, 2029" },
        { n: 25, title: "When two reports disagree \u2014 progress against valuation, reconciled first", short: "When two reports disagree", status: "live", page: "reporting-week-25.html", date: "Mar 7, 2029" },
        { n: 26, title: "The report nobody acts on \u2014 the most common failure, and what to change", short: "The report nobody acts on", status: "live", page: "reporting-week-26.html", date: "Mar 14, 2029" }
    ],
    get liveCount() { return this.weeks.filter(w => w.status === "live").length; },
    get progressPercent() { return Math.round((this.liveCount / this.totalWeeks) * 100); },
