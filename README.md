...
projects, in English. 199 lessons across eight tracks, published one a week
and free to read.
...
Build scripts read it through `tools/lesson_dates.py` rather than carrying
their own values. Before v213 each script held a hardcoded `DATE_ISO`; when
